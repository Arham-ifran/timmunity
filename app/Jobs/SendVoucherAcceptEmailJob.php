...
use App\Mail\SendVoucherAcceptEmail;
use App\Models\SiteSettings;
use Mail;

class SendVoucherAcceptEmailJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $data = new SendVoucherAcceptEmail($this->subject,$this->content,$this->details);
