...
<div class="content-wrapper">
    ...
    <section class="content-header top-header">
        <div class="row">
            ...
            <div class="col-md-3">
                <form action="{{route('admin.reports.sales.export')}}" method="GET" id="report_form">
                    <input type="hidden" name="customer_id" id="customer_id" value="">
                    <input type="hidden" name="sales_person_id" id="sales_person_id" value="">
                    <input type="hidden" name="sales_team" id="sales_team" value="">
                    ...
                    <input type="hidden" name="untaxed" id="untaxed" value="">
                    <input type="hidden" name="currency_id" id="untaxed" value="">
            ...
            <div class="row mt-2" style="padding-left: 15px;">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="salesteam_id" class="form-control">
    ...
    function refresh_graph_ajax(){
        ...
        $.ajax({
            ...
            data: {
                ...
                currency_id: ajax_data['currency'],
