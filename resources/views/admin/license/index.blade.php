        ...
        <section class="content">
          <div class="box pt-1">
             ...
             <div class="row box-body ">
                <div class="row mb-2">
                    <form method="POST" id="bulActionForm" style="display:none" action="{{ route('admin.change.bulk.license.status') }}">
                        <input type="hidden" name="ids">
                        <div class="col-md-4">
                            <select class="form-control" name="statuss" id="" required>
                                <option value="">---{{ __('Select Bulk Action ') }}---</option>
                                <option value="0">{{ __('De-Activate') }}</option>
                                <option value="1">{{ __('Activate') }}</option>
                                <option value="2">{{ __('Expired') }}</option>
                                <option value="5">{{ __('Mark as Used') }}</option>
                                <option value="4">{{ __('Mark as Un-Used') }}</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                 ...
                 <div class="table-responsive">
                    ...
                    {{-- <table id="license" class="table table-striped table-bordered  display nowrap" style="width:100%"> --}}
                    <table id="license" class="table table-striped table-bordered  nowrap no-footer " style="width:100%">
                        <thead>
                            <tr role="row">
                                {{-- <th></th> --}}
                                @canany(['License Active/Inactive','License Expired','License Mark As Read'])
                                <th>#</th>
                                @endcanany
