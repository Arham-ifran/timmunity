...
<head>
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet"
        href="{{ _asset('backend/bower_components/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
    <!-- Summernote CSS-->
    ...
    <style>
        ...
        .btn.btn-secondary.select-all-button-dtjs {
            border: 1px solid #009a71;
            background: #009a71;
            color: #fff;
         }
         
         .btn.btn-secondary.select-all-button-dtjs:hover {
            background: #fff;
            color: #009a71;
        }
...
<body class="hold-transition skin-green-light sidebar-mini" id="setting-page">
    ...
    <div class="wrapper">
        ...
        @include('admin.sections.js_keywords')
        @if ($last_segment == 'settings' || ($second_last_segment == 'settings' && $last_segment == 'sales'))
    ...
    @yield('scripts')
    <script type="text/javascript"
        src="https://cdn.jsdelivr.net/npm/jquery-validation@1.17.0/dist/localization/messages_{{ session()->get('locale') }}.js" />
