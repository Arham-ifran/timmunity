        ...
        <div class="col-md-4">
            ...
            <div class="login-box">
                ...
                <div class="login-box-body">
                    ...
                    <hr />
                    <form action="{{ route('user.verification.resend') }}" method="post">
                        @csrf
                        {{ __('Before proceeding, please check your email for a verification link. If you did not receive the email') }},
                        <div class="row">
                            <button type="submit"
                                class="bg-gareen btn skin-green-light-btn btn-block btn-flat">{{ __('click here to request another') }}</button>
                        </div>
                    </form>
                </div>
                <!-- /.login-box-body -->
