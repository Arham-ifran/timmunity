...
@section('title', __('Manufacturer Sales Analysis'))
@section('styles')
...
<div class="content-wrapper">
    ...
    <section class="content-header top-header">
        <div class="row">
            <div class="col-md-6">
                <h2>
                    {{ __('Manufacturer Sales Analysis') }}
                </h2>
            </div>
        </div>
    </section>
...
<script>
    ...
    ajax_data['salesperson_id'] = '';
    ajax_data['salesteam_id'] = '';
    ajax_data['currency'] = '';
    ajax_data['country_id'] = '';
    ajax_data['invoice_status'] = '';


    tableajaxurl = "{{ route('manufacturers.product.analysis') }}"
    ...
    $('body').on('change', 'select[name=salesperson_id]', function(){
        ajax_data['salesperson_id'] = $(this).val();
        refresh_graph_ajax();
    });
    $('body').on('change', 'select[name=salesteam_id]', function(){
        ajax_data['salesteam_id'] = $(this).val();
        refresh_graph_ajax();
    });
    ...
    var table = $('#manufacturerTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function(d){
                ...
                d.sales_person_id = ajax_data['salesperson_id'];
                d.sales_team_id = ajax_data['salesteam_id'];
