...
@section('title',  __('Manufacturer Profile'))
@section('styles')
...
<section class="content">
   <form class="timmunity-custom-dashboard-form mt-2 form-validate" id="manufacturer-form" action="{{route('manufacturers.profile')}}" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="main-box box">
         <!-- <div class="row"> -->
            <!-- <div class="box-header"> -->
               ...
               <!-- </div> -->
               <!-- <div class="col-md-12">
                    <div class="alert alert-info archive-alert alert-dismissible" id="reset-inscruction-alert" >
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
         ...
         <div class="col-xs-12">
            <div class="box box-success box-solid">
               <div class="box-header with-border">
                  <h3 class="box-title">{{ __('Manufacturer Profile') }}</h3>
                     ...
                     <div class="col-md-9">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="firstname">{{ __('Manufacturer Name') }}<small class="asterik" style="color:red">*</small></label>
                                 <input type="text" class="form-control @error('manufacturer_name') is-invalid @enderror" id="manufacturer_name" name="manufacturer_name" placeholder="Enter Manufacturer Name" value="{{ isset($model) ? old('manufacturer_name', $model->manufacturer_name ?? '').' '.(isset($keyword) ? $keyword : '' ) : '' }}" maxlength="30" aria-describedby="firstname" required />
                                 @error('manufacturer_name')
                                 <div id="manufacturer_name-error" class="invalid-feedback animated fadeInDown">{{ $message }}</div>
                                 @enderror
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label for="email">{{ __('Manufacturer Email') }}<small class="asterik" style="color:red">*</small></label>
                                 <input type="email" class="form-control @error('manufacturer_email') is-invalid @enderror" id="manufacturer_email" name="manufacturer_email" placeholder="Enter Manufacturer Email" value="{{ old('manufacturer_email', $model->manufacturer_email ?? '') }}" maxlength="255" aria-describedby="email" required />
                                 @error('manufacturer_email')
                                 <div id="manufacturer_email-error" class="invalid-feedback animated fadeInDown">{{ $message }}</div>
                                 @enderror
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-6 pt-5">
                              ...
                              href="{{ route('manufacturers.dashboard') }}">{{ __('Discard') }}</a>
