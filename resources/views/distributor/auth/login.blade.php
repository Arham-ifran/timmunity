...
@section('title', __('Distributor Login Form'))
@section('content')
                ...
                <div class="container">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="login-box-body">
                            ...
                            <h2 class="text-center">{{__('Distributor Login')}}</h2>
                            ...
                            <form action="{{route('distributor.login.submit')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        @if (Route::has('distributor.password.request'))
                                            <a class="reg-text text-center" href="{{ route('distributor.password.request') }}">
                                                {{ __('Forgot Password?') }}
                                            </a>
                                        @endif
                                    </div>
