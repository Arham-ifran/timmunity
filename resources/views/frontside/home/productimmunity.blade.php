...
/* Main */
.main {
  background-image: url("{{asset('frontside/dist/img/device/main-thirteen.png')}}");
     ...
     <section class="main">
        <div class="container">
            <div class="main-content text-center">
                <h1 >{{__('Become a TIMmunity Reseller')}}</h1>
                <h3>{{__('A voucher selling system to encourage people to use TIMmunity products')}}</h3>
            </div>
        </div>
    </section>
    <!-- Product -->
            ...
            <div class="row custom-row custom-row-section">
                <div class="col-md-6 col-sm-6">
                     <div class="product-content">
                        <h2 >The Product</h2>
                        <p >{{__('Product Immunity is a centralized system built for vendors to buy and sell vouchers for different products offered by TIMmunity GmbH and earn handsome profits.')}}</p>
                        <p >{{__('The registered resellers can buy vouchers for different TIMmunity products and sell them to their customers. They can purchase unlimited vouchers for one or more products.')}}</p>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-01.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-02.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        <h2 >{{__('Voucher Trading Platform')}}</h2>
                        <p >{{__('TIMmunity GmbH promotes its enterprise-grade products by selling vouchers to vendors. As a voucher selling system, Product Immunity allows the registered resellers to purchase and market these vouchers to their customers and get as much profit as they want.')}}</p>
    ...
    <section class="add-in section-padding">
        <div class="container">
            <div class="row custom-row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        <h2 >{{__('Positive Cash Flow')}}</h2>
                        <p >{{__('Maximize your earnings. The more you purchase and sell vouchers, the more opportunity instills in gain profits. With a hassle-free voucher ordering process, you can have the vouchers in a large quantity, but you will only be charged for the used ones.')}}</p>
                        <!-- <ul class="list add-on-list">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-03.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="sending-features section-padding">
        <div class="container">
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-04.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        <h2 >{{__('Increased Consumer Loyalty')}}</h2>
                        <p >{{__('Enhance customer loyalty by giving them sound and yielding rationale to enjoy TIMmunity products like never before. The end customers can use these products with reliability and affordability.')}}</p>
                        <!-- <p >{{__('AikQ blocks all spam entering your system')}}</p> -->
                        <!-- <ul class="list add-on-list">
    ...
    <section class="competative-features">
        <div class="container">
            <div class="competative-features-heading text-center">
                ...
                <p >{{__('Great for Businesses to Enhance Consumer Loyalty')}}</p>
            </div>
            <div class="row custom-row-section">
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-01.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4 >{{__('Easy Vouchers Ordering')}}</h4>
                        <p >{{__('Incredibly easy to order vouchers and send to your current and prospective customers to subscribe and use TIMmunity products.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-02.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4 >{{__('Pay for Used Vouchers')}}</h4>
                        <p >{{__('Pay for redeemed vouchers only. Vendors will be charged for the used vouchers and not for all, which he purchased in bulk.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-03.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4>{{__('Buy in Bulk')}}</h4>
                        <p >{{__('Place unlimited voucher orders to allow your customers to purchase and redeem them for multiple TIMmunity products.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-04.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4 >{{__('Unique Code Keys')}}</h4>
                        <p >{{__('Get the required number of specific codes with a unique key to identify the voucher type.  Codes will be sent to resellers via email.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-05.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4 >{{__('Flexible & Secure')}}</h4>
                        <p >{{__('This voucher reselling system is fully secured and flexible. Get more choices with the ease of TIMmunity solutions access.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="competative-features-content text-center">
                        <div class="competative-features-content-image">
                            <img src="{{asset('frontside/dist/img/device/pro-bottom-06.png')}}" class="img-responsive img-shadow">
                        </div>
                        <h4>{{__('Free Registration')}}</h4>
                        <p >{{__('No initial cost. Become TIMmunity registered member without paying a penny, create your vendor account and start trading.')}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="get-started-area">
                <div class="get-started-content text-center">
                    ...
                    <p >{{__('Let’s Start Earning Money Through Vouchers Trading!')}}</p>
                    <div class="get-started-buttons">
                        <a href="https://vm24.qdns1.com" target="_blank" class="try-now-btn">{{__('Try Now')}}</a>
