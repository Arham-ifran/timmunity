...
/* Main */
.main {
  background-image: url("{{asset('frontside/dist/img/device/main-seven.png')}}");
            ...
            <div class="row custom-row custom-row-section">
                <div class="col-md-6 col-sm-6">
                     <div class="product-content add-on-content">
                        ...
                        <p >{{__('overmail is a mail server built for individuals and enterprises to help them access their emails from all their mail clients or mobile devices. This high-fidelity platform allows the users to store, share, access, and manage their data, including emails, contacts, aliases, files, and much more.')}}</p>
                        <p >{{__('You can schedule emails and set auto-responders, and a lot more without spamming your inbox. Moreover, you can move your emails from other providers to overmail quickly and easily with optimal cyber protection.')}}</p>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-page7.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/overmail-01.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        <h2 >{{__('Mail Server')}}</h2>
                        <p >{{__('Access, move and manage your emails through your overmail account.')}}</p>
            ...
            <div class="row custom-row custom-row-section">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/overmail-02.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="sending-features section-padding">
        <div class="container">
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/overmail-03.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        ...
                        <p >{{__('overmail blocks all spam entering your system.')}}</p>
                        <!-- <ul class="list add-on-list">
    ...
    <section class="competative-features">
        <div class="container">
            <div class="competative-features-heading text-center">
                ...
                <p class="chrac-p">{{__('Send and receive your emails through encrypted connections via overmail.')}}</p>
            </div>
            <div class="row custom-row-section">
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
                        ...
                        <p>{{__('Schedule and send messages at a later time and date. Schedule as many email messages as you want right within your overmail account.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
            ...
            <div class="get-started-area">
                <div class="get-started-content text-center">
                    ...
                    <div class="get-started-buttons">
                        {{-- <a href="https://vm17.qdns3.com" target="_blank" class="try-now-btn">{{__('Try Now')}}</a> --}}
