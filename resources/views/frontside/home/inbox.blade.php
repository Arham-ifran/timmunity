...
/* Main */
.main {
  background-image: url("{{asset('frontside/dist/img/device/main-three.png')}}");
     ...
     <section class="main">
        <div class="container">
            <div class="main-content text-center">
                ...
                <p class="banner-p">{{__("Give your e-conversations an unparalleled, secure transformation.")}}</h3>
            </div>
        </div>
    </section>
    <!-- Product -->
            ...
            <div class="row custom-row custom-row-section">
                <div class="col-md-6 col-sm-6">
                     <div class="product-content add-on-content">
                        ...
                        <p >{{__('Inbox.De is a mail server built for individuals and enterprises to help them access their emails from all their mail clients or mobile devices. This high-fidelity platform allows the users to store, share, access, and manage their data, including emails, contacts, aliases, files, and much more.')}}</p>
                        <p >{{__('You can schedule emails and set auto-responders,and a lot more without spamming your inbox.Moreover,you can move your emails from other providers to Inbox.De quickly and easily with optimal cyber protection.')}}</p>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/product-page3.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/inbox-01.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        <h2 >{{__('Mail Server')}}</h2>
                        <p >{{__('Access, move and manage your emails through your Inbox.De account.')}}</p>
            ...
            <div class="row custom-row custom-row-section">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image product-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/inbox-02.png')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="sending-features section-padding">
        <div class="container">
            <div class="row custom-row-section">
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-image"data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" class="aos-init aos-animate">
                        <img src="{{asset('frontside/dist/img/device/inbox-03.png')}}" class="img-responsive">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="add-on-content">
                        ...
                        <p >{{__('Inbox.De blocks all spam entering your system.')}}</p>
                        <!-- <ul class="list add-on-list">
    ...
    <section class="competative-features">
        <div class="container">
            <div class="competative-features-heading text-center">
                ...
                <p class="chrac-p">{{__('Send and receive your emails through encrypted connections via Inbox.De mail server.')}}</p>
            </div>
            <div class="row custom-row-section">
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
                        ...
                        <p>{{__('Schedule and send messages at a later time and date. Schedule as many email messages as you want right within your Inbox.De account.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
                ...
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
                        ...
                        <p >{{__('Manage your multiple email aliases for the same account. You can have alternate mailbox names for your mailing lists and accounts.')}}</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="competative-features-content text-center">
            ...
            <div class="get-started-area">
                <div class="get-started-content text-center">
                    ...
                    <div class="get-started-buttons">
                        <a href="https://www.inbox.de/" target="_blank" class="try-now-btn">{{__('Try Now')}}</a>
