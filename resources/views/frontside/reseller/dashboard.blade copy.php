...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            {{-- <div class="col-md-12">
                <div class="text-center mt-3">
                    <a class="btn btn-large btn-primary get-more-voucher-btn" data-toggle="modal"
                        data-target="#getVoucherModal"><span>{{ __('Get more vouchers') }}</span>
                    </a>
                    <a class="btn btn-large btn-warning get-more-voucher-btn" target="_blank" href="{{ route('voucher.view.redeemed', Hashids::encode(@$redeem_page->reseller_id)) }}">
                        {{ __('Visit Redeem Page') }}
                    </a>
                </div>
            </div> --}}
        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="text-center mt-3">
                        <div class="input-group">
                            <input type="text" id="redeem_url" class="form-control" readonly value="{{$redeem_page->url}}">
                            <span class="input-group-addon copy-link" title="Click to copy"><i class="fa fa-copy"></i></span>
                        </div>
                    </div>
                </div>
            </div>
