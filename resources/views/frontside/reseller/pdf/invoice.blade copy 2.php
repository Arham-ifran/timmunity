                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr
                                            ...
                                            <th
                                                style="width:40px;font-weight: 600;text-align: left;padding: 4px 0;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Pos')}}</th>
                                            <th
                                                style="margin-left:5px;width:220px;font-weight: 600;text-align: left;padding: 4px 0;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Order ID')}}
                                            </th>
                                            <th
                                            ...
                                            <th
                                                style="width:80px;font-weight: 600;text-align: left !important;padding: 4px 0px;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Quantity')}}
                                            </th>
                                            <th
                                                style="width:90px;font-weight: 600;text-align: left !important;padding: 4px 0;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Unit Price')}}
                                            </th>
                                            <th
                                                style="width:90px;font-weight: 600;text-align: left !important;padding: 4px 0;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Taxes')}}</th>
                                            <th
                                                style="width:100px;font-weight: 600;text-align: left !important;padding: 4px 0;font-family: Roboto, RobotoDraft, Helvetica, Arial, sans-serif, 'Segoe UI', 'sans-serif';">
                                                {{__('Total Price')}}
                                            </th>
                                        </tr>
                                    </thead>
